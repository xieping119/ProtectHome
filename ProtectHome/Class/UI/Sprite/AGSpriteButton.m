...
+(AGSpriteButton *)buttonWithImageNamed:(NSString *)image chosedImage:(NSString*)chosedImage;
{
    AGSpriteButton *newButton = [[AGSpriteButton alloc]initWithImageNamed:image chosedImage:chosedImage];
...
-(instancetype)initWithImageNamed:(NSString *)name chosedImage:(NSString*)chosedImage;
{
    [self setNoramlTexture:[SKTexture textureWithImageNamed:name]];
    [self setChosedTexture:[SKTexture textureWithImageNamed:chosedImage]];
    
    if (self = [super initWithTexture:[self noramlTexture]])
    {
...
-(void)transformForTouchDown
{
    ...
    [self setTexture:[self chosedTexture]];
...
{
    //You can define your custom transformation here.
    [self setTexture:[self noramlTexture]];
